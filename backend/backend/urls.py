...
from core.backup_views import BackupDownloadView, BackupRestoreView
...
urlpatterns = [
    ...
    path('api/auth/backup/restore/', BackupRestoreView.as_view(), name='backup-restore'),
    ...
    path('api/', include('roznamcha.urls')),
